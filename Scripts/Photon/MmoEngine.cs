...
public class MmoEngine : Radar, IGameListener
{
    ...
    public void OnItemRemoved(Game game, Item item)
    {
        ...
        if (actor != null)
        {
            ...
            GameObject GO=actor.transform.gameObject;
            behaviour.Destroy();
            Destroy(GO);
    ...
    public void OnWorldEntered(Game game)
    {
        ...
        GameObject player = GameObject.FindGameObjectWithTag("Player");//.Find("CAR_V2");
    ...
    private void CreateActor(Game engine, Item actor)
    {
        ...
        if (actor != engine.Avatar)
        {
            ...
            GameObject actorGO = ActorInstanciator.Instance.Instanciate_TestCar();
            Actor actorBehaviour = (Actor)actorGO.AddComponent(typeof(Actor));
